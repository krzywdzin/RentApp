...
- [x] **QUAL-03**: Dead code removed (unused imports, unused DB fields documented, unused exports)
...
- [x] **QUAL-07**: Web unsafe 'as' casts on form submits replaced with proper typing
